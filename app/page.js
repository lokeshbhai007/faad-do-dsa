    ...
    <main className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-col md:flex-col gap-6 mx-10">
        ...
        <div className="w-full">
          <Link
            href="/all-questions"
            className="flex items-center justify-center p-4 bg-blue-50 text-blue-600 rounded-lg shadow-sm border border-blue-200 hover:bg-blue-100 transition-colors"
          >
